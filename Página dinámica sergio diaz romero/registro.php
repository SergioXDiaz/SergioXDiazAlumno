...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_registro = "INSERT INTO usuario (nombre, email, pass, rol) 
                     VALUES('$nombre', '$email', MD5('$pass'), 0)";
...
<head>
	...
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
		<link rel="stylesheet" type="text/css" href="C:\xampp2\htdocs\dashboard\Tema1PHP\SergioXDiazAlumno\PAGINAS WEB PROYECTO\css\my-login.css">
</head>
		...
		<div class="row justify-content-center">
			<div class="col-md-6 col-lg-4">
				...
				<div class="text-center mt-3 text-muted">
					Copyright © 2026 — Videoclub Retro 
				</div>
